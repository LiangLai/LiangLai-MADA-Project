...
Once downloaded, the raw files should be placed in the `data/raw-data/` directory following the folder structure described above. All scripts in this repository assume this directory structure and use relative paths via the `here` package.
